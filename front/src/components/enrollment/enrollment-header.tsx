...
import { INSTITUTION_DANE_CODE, INSTITUTION_LICENSE, INSTITUTION_NAME, INSTITUTION_SLOGAN } from '@/consts/shared';

const InstitutionInfo = () => {
  return (
    <div className="flex flex-col items-center text-center">
      <h1 className="text-2xl font-bold text-primary uppercase">{INSTITUTION_NAME}</h1>
      <p className="text-xs text-muted-foreground leading-relaxed">{INSTITUTION_SLOGAN}</p>
...
function EnrollmentHeader({ control, studentPhotoError }: EnrollmentHeaderProps) {
  return (
    <CardHeader>
