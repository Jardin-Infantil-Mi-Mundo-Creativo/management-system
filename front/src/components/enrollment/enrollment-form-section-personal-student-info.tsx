...
import { calculateAgeMonths, calculateAgeYears } from '@/utils/enrollment/calculate-age';
...
interface EnrollmentFormSectionPersonalStudentInfoProps {
  ...
  personalStudentInfoErrors?: Merge<FieldError, FieldErrorsImpl<EnrollmentFormSchema['personalStudentInfo']>>;
    ...
    <>
      ...
      <div className='flex gap-4 flex-wrap'>
        ...
        <InputGroup
          ...
          errorMessage={personalStudentInfoErrors?.civilRegistrationNumber?.message}
        />
      </div>
    </>
  )
