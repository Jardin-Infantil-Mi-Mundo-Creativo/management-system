...
interface EnrollmentData {
  ...
  mother: {
    ...
    occupation: string
    educationLevel: 'primary school' | 'secondary school' | 'technical' | 'university'
  }
  father: {
    fullName: string
    birthDate: string
  ...
  familyRelationship: {
    ...
    parentsRelationship?: 'married' | 'common law marriage' | 'single mother' | 'separated'
  }
  enrollment: {
    ...
    entryGrade?: 'walkers' | 'toddlers' | 'preschool' | 'kindergarten' | 'transition' | 'first grade'
  }
